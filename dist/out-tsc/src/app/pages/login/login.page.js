...
var LoginPage = /** @class */ (function () {
    function LoginPage(router, apiService, r) {
        this.router = router;
    ...
    LoginPage.prototype.onLogin = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.apiService.LoginAsync(this.userInfo.UserName, this.userInfo.Password)];
                    case 1:
                        res = _a.sent();
                        ...
                        return [4 /*yield*/, this.apiService.setData(this.r.UserInfoKey, this.userInfo)];
                    case 2:
                        _a.sent();
